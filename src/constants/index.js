...
const projects = [
  ...
  },
  {
    ...
    description:
      "Designed and implemented a low-latency backtesting and live-trading engine in Python, integrating real-time market data APIs (Alpaca, yfinance) with advanced risk metrics (Sharpe, Sortino, max drawdown, Value-at-Risk). Optimized the trade signal pipeline with vectorized Pandas/Numpy operations, cutting backtest runtime by 45% while processing 2M+ historical data points. Built a modular strategy framework supporting SMA crossover, RSI, and custom alpha models for rapid prototyping and seamless deployment to paper/live accounts. Added dynamic position sizing and stop-loss/take-profit rules, improving drawdown control and boosting simulated CAGR by ~12% over baseline in multi-year tests. Developed a matplotlib visualization suite for equity curves, drawdowns, and PnL distributions, plus a CLI for flexible execution in historical or streaming modes. GitHub repo includes a detailed README, usage examples, performance charts, and live-trading demos.",
    tags: [
      {
        name: "Python",
        color: "blue-text-gradient",
